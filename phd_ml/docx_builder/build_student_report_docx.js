...
const STATUS = [
  ...
  tableFa(
    [
      ["وضعیت", "اقدام"],
      ["فاز ۱ — کد و خروجی‌ها کامیت شدند", "استاد روش‌شناسی Phase 1 (سند Word یا Markdown) را بررسی و تأیید کند"],
      ["فاز ۲ — کد آماده، در انتظار اجرا", "دانشجو در محیط محلی pipeline را اجرا کند و نتایج را push کند"],
      ["فاز ۳ — هنوز شروع نشده", "پس از تأیید فاز ۲، کد 1D-CNN با augmentation نوشته می‌شود"],
